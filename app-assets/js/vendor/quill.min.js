    ...
    return (function (t) {
        ...
        function (t, e, n) {
            ...
            i.default.register({
                ...
                o.default.register(a.default, s.default, c.default, h.default, p.default, d.default),
                (t.exports = i.default);
        },
        function (t, e, n) {
            "use strict";
        ...
        function (t, e) {
            ...
            function n(t, e) {
                var n;
                if ((void 0 === e && (e = u.ANY), "string" == typeof t)) n = s[t] || i[t];
                else if (t instanceof Text) n = s.text;
                else if ("number" == typeof t) t & u.LEVEL & u.BLOCK ? (n = s.block) : t & u.LEVEL & u.INLINE && (n = s.inline);
                else if (t instanceof HTMLElement) {
                    var r = (t.getAttribute("class") || "").split(/\s+/);
                    for (var o in r) if ((n = l[r[o]])) break;
                    n = n || a[t.tagName];
                }
                return null == n ? null : e & u.LEVEL & n.scope && e & u.TYPE & n.scope ? n : null;
            }
            var r =
                    (this && this.__extends) ||
                    function (t, e) {
            ...
            (e.create = function (t, e) {
                var r = n(t);
                if (null == r) throw new o("Unable to create " + t + " blot");
                var i = r,
                    l = t instanceof Node ? t : i.create(e);
                return new i(l, e);
            }),
                ...
                (e.register = function t() {
                    ...
                    if (((s[r.blotName || r.attrName] = r), "string" == typeof r.keyName)) i[r.keyName] = r;
                        ...
                        var u = Array.isArray(r.tagName) ? r.tagName : [r.tagName];
                        u.forEach(function (t) {
                            (null != a[t] && null != r.className) || (a[t] = r);
                        });
                    }
                    return r;
                });
        ...
        function (t, e, n) {
            ...
            function i(t, e) {
                if (null == (e = (0, g.default)(!0, { container: t, modules: { clipboard: !0, keyboard: !0, history: !0 } }, e)).theme || e.theme === w.DEFAULTS.theme) e.theme = _.default;
                ...
                return (
                    ...
                    (e = (0, g.default)(!0, {}, w.DEFAULTS, { modules: r }, n, e)),
            ...
            function l(t, e, n, r, o) {
                ...
                return (
                    ...
                    "object" === (void 0 === n ? "undefined" : s(n)) ? ((i = n), (o = r)) : "string" == typeof n && (null != r ? (i[n] = r) : (o = n)),
                    [t, e, i, (o = o || p.default.sources.API)]
                );
            }
            function a(t, e, n, r) {
                ...
                w = (function () {
                    function t(e) {
                        ...
                        this.container.classList.add("ql-container"),
                            ...
                            (this.scroll = y.default.create(this.root, { emitter: this.emitter, whitelist: r.formats })),
                            (this.editor = new h.default(this.scroll, this.emitter)),
                            ...
                            this.emitter.on(p.default.events.TEXT_CHANGE, function (t) {
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    ...
                                    if ("string" != typeof t) {
                                        ...
                                        null == this.imports[t] || r || O.warn("Overwriting " + t + " with", e),
                                            (this.imports[t] = e),
                                            (t.startsWith("blots/") || t.startsWith("formats/")) && "abstract" !== e.blotName && y.default.register(e);
                                },
                            },
                        ]),
                        c(t, [
            ...
            (w.DEFAULTS = { bounds: document.body, formats: null, modules: {}, placeholder: "", readOnly: !1, theme: "default" }),
                (w.events = p.default.events),
                (w.sources = p.default.sources),
                (w.version = "1.0.0"),
                (w.imports = { delta: f.default, parchment: y.default, "core/module": d.default, "core/theme": _.default }),
                (e.expandConfig = i),
                (e.overload = l),
                (e.default = w);
        },
        ...
        function (t, e) {
            function n(t, e) {
                ...
                return (
                    ...
                    (function t(e) {
                        e.push([f, ""]);
                        for (var n, r = 0, o = 0, i = 0, s = "", h = ""; r < e.length; )
                            switch (e[r][0]) {
                                case c:
                                    i++, (h += e[r][1]), r++;
                                    break;
                                ...
                                case f:
                                    o + i > 1
                                        ? (0 !== o &&
                                              0 !== i &&
                                              (0 !== (n = l(h, s)) &&
                                                  (r - o - i > 0 && e[r - o - i - 1][0] == f ? (e[r - o - i - 1][1] += h.substring(0, n)) : (e.splice(0, 0, [f, h.substring(0, n)]), r++), (h = h.substring(n)), (s = s.substring(n))),
                                              0 !== (n = a(h, s)) && ((e[r][1] = h.substring(h.length - n) + e[r][1]), (h = h.substring(0, h.length - n)), (s = s.substring(0, s.length - n)))),
                                          0 === o ? e.splice(r - i, o + i, [c, h]) : 0 === i ? e.splice(r - o, o + i, [u, s]) : e.splice(r - o - i, o + i, [u, s], [c, h]),
                                          (r = r - o - i + (o ? 1 : 0) + (i ? 1 : 0) + 1))
                                        : 0 !== r && e[r - 1][0] == f
                        ...
                        for (r = 1; r < e.length - 1; )
                            e[r - 1][0] == f &&
                                ...
                                (e[r][1].substring(e[r][1].length - e[r - 1][1].length) == e[r - 1][1]
                                    ? ((e[r][1] = e[r - 1][1] + e[r][1].substring(0, e[r][1].length - e[r - 1][1].length)), (e[r + 1][1] = e[r - 1][1] + e[r + 1][1]), e.splice(r - 1, 1), (p = !0))
                                    : e[r][1].substring(0, e[r + 1][1].length) == e[r + 1][1] && ((e[r - 1][1] += e[r + 1][1]), (e[r][1] = e[r][1].substring(e[r + 1][1].length) + e[r + 1][1]), e.splice(r + 1, 1), (p = !0))),
                                r++;
                        p && t(e);
                    })(s),
                    s
            ...
            function r(t, e) {
                ...
                if (-1 != a)
                    return (
                        (r = [
                            [c, i.substring(0, a)],
                            [f, l],
                            [c, i.substring(a + l.length)],
                        ]),
                        t.length > e.length && (r[0][0] = r[2][0] = u),
                        r
                    );
                if (1 == l.length)
                    return [
                ...
                if (h) {
                    var p = h[0],
                        ...
                        g = n(p, y),
                        m = n(d, v);
                    return g.concat([[f, b]], m);
                }
                return o(t, e);
            }
            function o(t, e) {
                for (var n = t.length, r = e.length, o = Math.ceil((n + r) / 2), l = o, a = 2 * o, s = new Array(a), f = new Array(a), h = 0; h < a; h++) (s[h] = -1), (f[h] = -1);
                (s[l + 1] = 0), (f[l + 1] = 0);
                for (var p = n - r, d = p % 2 != 0, y = 0, v = 0, b = 0, g = 0, m = 0; m < o; m++) {
                    for (var _ = -m + y; _ <= m - v; _ += 2) {
                        for (var O = l + _, w = (A = _ == -m || (_ != m && s[O - 1] < s[O + 1]) ? s[O + 1] : s[O - 1] + 1) - _; A < n && w < r && t.charAt(A) == e.charAt(w); ) A++, w++;
                        if (((s[O] = A), A > n)) v += 2;
                        else if (w > r) y += 2;
                        else if (d) {
                            if ((E = l + p - _) >= 0 && E < a && -1 != f[E]) if (A >= (k = n - f[E])) return i(t, e, A, w);
                        }
                    }
                    for (var x = -m + b; x <= m - g; x += 2) {
                        for (var k, E = l + x, j = (k = x == -m || (x != m && f[E - 1] < f[E + 1]) ? f[E + 1] : f[E - 1] + 1) - x; k < n && j < r && t.charAt(n - k - 1) == e.charAt(r - j - 1); ) k++, j++;
                        if (((f[E] = k), k > n)) g += 2;
                        else if (j > r) b += 2;
                        else if (!d) {
                            if ((O = l + p - x) >= 0 && O < a && -1 != s[O]) {
                                var A;
                                w = l + (A = s[O]) - O;
                                if (A >= (k = n - k)) return i(t, e, A, w);
                            }
                        }
                    }
                }
            ...
            function s(t, e) {
                ...
                var i,
                    ...
                    c,
                    f,
                    h = n(r, o, Math.ceil(r.length / 4)),
                    p = n(r, o, Math.ceil(r.length / 2));
                return h || p ? ((i = p ? (h && h[4].length > p[4].length ? h : p) : h), t.length > e.length ? ((s = i[0]), (u = i[1]), (c = i[2]), (f = i[3])) : ((c = i[0]), (f = i[1]), (s = i[2]), (u = i[3])), [s, u, c, f, i[4]]) : null;
            }
            var u = -1,
                c = 1,
                f = 0,
                h = n;
            (h.INSERT = c), (h.DELETE = u), (h.EQUAL = f), (t.exports = h);
        },
        function (t, e, n) {
            function r(t) {
                return null == t;
        ...
        function (t, e, n) {
            ...
            function l(t) {
                return t.ops.reduce(function (t, e) {
                    if (1 === e.insert) {
                        var n = (0, g.default)(e.attributes);
                        return delete n.image, t.insert({ image: e.attributes.image }, n);
                    }
                    if (
                        (null == e.attributes ||
                            (!0 !== e.attributes.list && !0 !== e.attributes.bullet) ||
                            ((e = (0, g.default)(e)).attributes.list ? (e.attributes.list = "ordered") : ((e.attributes.list = "bullet"), delete e.attributes.bullet)),
                ...
                O = (function () {
                    function t(e, n) {
                        (function (t, e) {
                            ...
                            (this.scroll = e),
                            (this.emitter = n),
                            this.emitter.on(h.default.events.SCROLL_UPDATE, this.update.bind(this, null)),
                        ...
                        u(t, [
                            {
                                ...
                                value: function (t) {
                                    var e = this,
                                        n = arguments.length <= 1 || void 0 === arguments[1] ? h.default.sources.API : arguments[1],
                                        r = !1;
                                    this.scroll.update();
                                    var o = this.scroll.length();
                                    return (
                                        (this.scroll.batch = !0),
                                        (t = l(t)).ops.reduce(function (t, n) {
                                            var i = n.retain || n.delete || n.insert.length || 1,
                                                l = n.attributes || {};
                                            if (null != n.insert) {
                                                if ("string" == typeof n.insert) {
                                                    var u = n.insert;
                                                    u.endsWith("\n") && r && ((r = !1), (u = u.slice(0, -1))), t >= o && !u.endsWith("\n") && (r = !0), e.scroll.insertAt(t, u);
                                                    var c = e.scroll.line(t),
                                                        h = s(c, 2),
                                                        d = h[0],
                                                        y = h[1],
                                                        g = (0, _.default)({}, (0, v.bubbleFormats)(d));
                                                    if (d instanceof b.default) {
                                                        var m = d.descendant(p.default.Leaf, y),
                                                            O = s(m, 1)[0];
                                                        g = (0, _.default)(g, (0, v.bubbleFormats)(O));
                                                    }
                                                    l = f.default.attributes.diff(g, l) || {};
                                                } else if ("object" === a(n.insert)) {
                            ...
                            },
                            {
                                key: "deleteText",
                                value: function (t, e) {
                                    var n = arguments.length <= 2 || void 0 === arguments[2] ? h.default.sources.API : arguments[2];
                                    return this.scroll.deleteAt(t, e), this.update(new c.default().retain(t).delete(e), n);
                                },
                            },
                            {
                                key: "enable",
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    var n = this,
                                        r = arguments.length <= 2 || void 0 === arguments[2] ? {} : arguments[2],
                                        o = arguments.length <= 3 || void 0 === arguments[3] ? h.default.sources.API : arguments[3];
                                    return (
                                        this.scroll.update(),
                                        ...
                                        this.scroll.optimize(),
                                        this.update(new c.default().retain(t).retain(e, (0, g.default)(r)), o)
                                    );
                                },
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    0 === e
                                        ? this.scroll.path(t).forEach(function (t) {
                                              var e = s(t, 1)[0];
                                              e instanceof b.default ? n.push(e) : e instanceof p.default.Leaf && r.push(e);
                                          })
                                        : ((n = this.scroll.lines(t, e)), (r = this.scroll.descendants(p.default.Leaf, t, e)));
                                    var o = [n, r].map(function (t) {
                                        if (0 === t.length) return {};
                                        for (var e = (0, v.bubbleFormats)(t.shift()); Object.keys(e).length > 0; ) {
                                            var n = t.shift();
                                            if (null == n) return e;
                                            e = i((0, v.bubbleFormats)(n), e);
                                        }
                                        return e;
                                    });
                                    return _.default.apply(_.default, o);
                                },
                            },
                            {
                                key: "getText",
                            ...
                            },
                            {
                                key: "insertEmbed",
                                value: function (t, e, n) {
                                    var r = arguments.length <= 3 || void 0 === arguments[3] ? h.default.sources.API : arguments[3];
                                    return this.scroll.insertAt(t, e, n), this.update(new c.default().retain(t).insert(o({}, e, n)), r);
                                },
                            },
                            {
                                key: "insertText",
                                value: function (t, e) {
                                    ...
                                    return (
                                        ...
                                        this.update(new c.default().retain(t).insert(e, (0, g.default)(r)), o)
                                    );
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function (t, e, n) {
                                    var r = this.getText(t, e),
                                        ...
                                        f = new c.default();
                                    null != l &&
                                        ((u = l instanceof d.default ? l.newlineIndex(a) - a + 1 : l.length() - a),
                                        (f = l
                                            .delta()
                                            .slice(a, a + u - 1)
                                            .insert("\n")));
                                    var h = this.getContents(t, e + u).diff(new c.default().insert(r).concat(f)),
                                        p = new c.default().retain(t).concat(h);
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    var e = this,
                                        n = arguments.length <= 1 || void 0 === arguments[1] ? h.default.sources.USER : arguments[1],
                                        r = arguments.length <= 2 || void 0 === arguments[2] ? [] : arguments[2],
                                        o = this.delta;
                                    if (
                                        (1 === r.length && "characterData" === r[0].type && p.default.find(r[0].target)
                                            ? (function () {
                                                  var n = p.default.find(r[0].target),
                                                      i = (0, v.bubbleFormats)(n),
                                                      l = n.offset(e.scroll),
                                                      a = r[0].oldValue.replace(y.default.CONTENTS, ""),
                                                      s = new c.default().insert(a),
                                                      u = new c.default().insert(n.value()),
                                                      f = new c.default().retain(l).concat(s.diff(u));
                                                  (t = f.ops.reduce(function (t, e) {
                                                      return e.insert ? t.insert(e.insert, i) : t.push(e);
                                                  }, new c.default())),
                                                      (e.delta = o.compose(t));
                                              })()
                                            : ((this.delta = this.getDelta()), (t && (0, m.default)(o.compose(t), this.delta)) || (t = o.diff(this.delta))),
                                        t.length() > 0)
                                    ) {
                                        var i,
                                            l,
                                            a = [h.default.events.TEXT_CHANGE, t, o, n];
                                        if (((i = this.emitter).emit.apply(i, [h.default.events.EDITOR_CHANGE].concat(a)), n !== h.default.sources.SILENT)) (l = this.emitter).emit.apply(l, a);
                                    }
                                    return t;
                                },
                            },
        ...
        function (t, e, n) {
            ...
            var o = (function () {
                ...
                l = r(n(29)),
                a = (0, r(n(30)).default)("quill:events"),
                s = (function (t) {
                    function e() {
                        !(function (t, e) {
                            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
                        ...
                        o(e, [
                            {
                                key: "emit",
                                value: function () {
                                    a.log.apply(a, arguments), i(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "emit", this).apply(this, arguments);
                                },
                            },
                        ]),
                        e
                                    ...
                                    value: function (t, n) {
                                        0 === t.children.length &&
                                            (function t(e, n, r) {
                                                ...
                                                var l = o.get;
                                                return void 0 !== l ? l.call(r) : void 0;
                                            })(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "insertInto", this).call(this, t, n);
                                    },
                                },
                                {
                                    key: "length",
        ...
        function (t, e, n) {
                            ...
                            [
                                {
                                    key: "formatAt",
                                    value: function (t, n, r, o) {
                                        if (e.compare(this.statics.blotName, r) < 0 && c.default.query(r, c.default.Scope.BLOT)) {
                                            ...
                                            (function t(e, n, r) {
                                                ...
                                                var l = o.get;
                                                return void 0 !== l ? l.call(r) : void 0;
                                            })(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "formatAt", this).call(this, t, n, r, o);
                                    },
                                },
                            ],
                            [
            ...
            (f.allowedChildren = [f, s.default, u.default]), (f.order = ["cursor", "inline", "code", "underline", "strike", "italic", "bold", "script", "link"]), (e.default = f);
        },
        function (t, e, n) {
            "use strict";
            function r(t, e) {
        ...
        function (t, e, n) {
            ...
            var o = function (t, e) {
                ...
                c = (function (t) {
                    ...
                    return (
                        ...
                        l(e, null, [{ key: "value", value: function (t) {} }]),
                        l(e, [
                            {
                                key: "detach",
                                value: function () {
                                    ...
                                    if (!this.selection.composing && null != this.parent) {
                                        ...
                                        this.textNode.data !== e.CONTENTS &&
                                            ...
                                            null != r &&
                                                r.start.node === n &&
                                                r.end.node === n &&
                                                this.selection.emitter.once(u.default.events.SCROLL_OPTIMIZE, function () {
                                                    var e = [r.start.offset, r.end.offset].map(function (t) {
                                                        ...
                                                        l = i[0],
                                                        a = i[1];
                                                    t.selection.setNativeRange(n, l, n, a);
                                                });
                                    }
                                },
                            },
            ...
            (c.blotName = "cursor"), (c.className = "ql-cursor"), (c.tagName = "span"), (c.CONTENTS = "\ufeff"), (e.default = c);
        },
        function (t, e) {
            var n = (function () {
                "use strict";
                function t(e, r, o, i) {
                    ...
                    return (
                        ...
                        (function e(o, u) {
                            ...
                            if (t.__isArray(o)) c = [];
                            else if (t.__isRegExp(o)) (c = new RegExp(o.source, n(o))), o.lastIndex && (c.lastIndex = o.lastIndex);
                            else if (t.__isDate(o)) c = new Date(o.getTime());
                            else {
                                if (s && Buffer.isBuffer(o)) return (c = new Buffer(o.length)), o.copy(c), c;
                                void 0 === i ? ((f = Object.getPrototypeOf(o)), (c = Object.create(f))) : ((c = Object.create(i)), (f = i));
                            }
                            if (r) {
                                var h = l.indexOf(o);
                                if (-1 != h) return a[h];
                            ...
                            for (var p in o) {
                                var d;
                                f && (d = Object.getOwnPropertyDescriptor(f, p)), (d && null == d.set) || (c[p] = e(o[p], u - 1));
                            }
                            return c;
                        })(e, o)
                    );
        ...
        function (t, e, n) {
            ...
            var a = function (t, e) {
                ...
                h = (r(n(33)), n(28)),
                p = r(h),
                d = (0, r(n(30)).default)("quill:selection"),
                y = function t(e) {
                        ...
                        s(t, [
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    ...
                                    if ((d.info("setNativeRange", t, e, n, r), null == t || (null != this.root.parentNode && null != t.parentNode && null != n.parentNode))) {
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    var e = this,
                                        ...
                                        r = arguments.length <= 2 || void 0 === arguments[2] ? p.default.sources.API : arguments[2];
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    if (((this.lastRange = o[0]), (e = o[1]), null != this.lastRange && (this.savedRange = this.lastRange), !(0, f.default)(n, this.lastRange))) {
                                        ...
                                        var l,
                                            s = [p.default.events.SELECTION_CHANGE, (0, c.default)(this.lastRange), (0, c.default)(n), t];
                                        if (((i = this.emitter).emit.apply(i, [p.default.events.EDITOR_CHANGE].concat(s)), t !== p.default.sources.SILENT)) (l = this.emitter).emit.apply(l, s);
                                    }
                                },
                            },
                        ]),
        ...
        function (t, e, n) {
            ...
            (l.DEFAULTS = { modules: {} }), (l.themes = { default: l }), (e.default = l);
        },
        function (t, e, n) {
            "use strict";
            function r(t) {
            ...
            (u.allowedChildren = [s.default, a.BlockEmbed, u]), (e.default = u);
        },
        function (t, e, n) {
            "use strict";
            function r(t) {
                        ...
                        l(e, [
                            {
                                ...
                                value: function (t, n) {
                                    var r = this.line(t),
                                        ...
                                        u = this.line(t + n),
                                        f = i(u, 1)[0];
                                    if ((a(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "deleteAt", this).call(this, t, n), null != f && l !== f && s > 0 && !(l instanceof c.BlockEmbed) && !(f instanceof c.BlockEmbed))) {
                                        f instanceof d.default && f.deleteAt(f.length() - 1, 1);
                                        var p = f.children.head instanceof h.default ? null : f.children.head;
                                        l.moveChildren(f, p), l.remove();
                                    }
                                    this.optimize();
                                },
                            },
                                        ...
                                        n = function t(e, n, r) {
                                            ...
                                            return (
                                                e.children.forEachAt(n, r, function (e, n, r) {
                                                    o(e) ? i.push(e) : e instanceof s.default.Container && (i = i.concat(t(e, n, l))), (l -= r);
                                                }),
                                                i
                                            );
                                        };
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    var t = arguments.length <= 0 || void 0 === arguments[0] ? [] : arguments[0];
                                    !0 !== this.batch && (a(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "optimize", this).call(this, t), t.length > 0 && this.emitter.emit(u.default.events.SCROLL_OPTIMIZE, t));
                                },
                            },
                            {
                                key: "path",
                                value: function (t) {
                                    return a(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "path", this)
                                        .call(this, t)
                                        .slice(1);
                                },
                            },
                                ...
                                value: function (t) {
                                    if (!0 !== this.batch) {
                                        ...
                                        "string" == typeof t && (n = t),
                                            ...
                                            a(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "update", this).call(this, t.concat([])),
        ...
        function (t, e, n) {
            ...
            function s(t, e, n) {
                return n.compose(new v.default().retain(n.length(), o({}, t, !0)));
            }
            function u(t, e) {
                var n = b.default.Attributor.Attribute.keys(t),
                    r = b.default.Attributor.Class.keys(t),
                    o = b.default.Attributor.Style.keys(t),
                    i = {};
                return (
                    n
                        .concat(r)
                        .concat(o)
                        .forEach(function (e) {
                            var n = b.default.query(e, b.default.Scope.ATTRIBUTE);
                            (null != n && ((i[n.attrName] = n.value(t)), i[n.attrName])) || (null != q[e] && ((n = q[e]), (i[n.attrName] = n.value(t))));
                        }),
                    Object.keys(i).length > 0 && (e = e.compose(new v.default().retain(e.length(), i))),
                    e
                );
            }
            function c(t, e) {
                var n = b.default.query(t);
                if (null == n) return e;
                if (n.prototype instanceof b.default.Embed) {
                    var r = {},
                        i = n.value(t);
                    null != i && ((r[n.blotName] = i), (e = new v.default().insert(r, n.formats(t))));
                } else if ("function" == typeof n.formats) {
                    var l = o({}, n.blotName, n.formats(t));
                    e = e.compose(new v.default().retain(e.length(), l));
                }
                return e;
            }
            function f(t, e) {
            ...
            function h(t, e) {
                if (a(t) && null != t.nextElementSibling && !l(e, "\n\n")) {
            ...
            function p(t, e) {
                ...
                if (!i(t.parentNode).whiteSpace.startsWith("pre")) {
                    ...
                    (n = (n = n.replace(/\r\n/g, " ").replace(/\n/g, " ")).replace(/\s\s+/g, r.bind(r, !0))),
                        ((null == t.previousSibling && a(t.parentNode)) || (null != t.previousSibling && a(t.previousSibling))) && (n = n.replace(/^\s+/, r.bind(r, !1))),
                        ((null == t.nextSibling && a(t.parentNode)) || (null != t.nextSibling && a(t.nextSibling))) && (n = n.replace(/\s+$/, r.bind(r, !1)));
                }
                return e.insert(n);
            }
            ...
            var d = function (t, e) {
                    ...
                    [
                        ...
                        function (t, e) {
                            var n = {},
                                r = t.style || {};
                            return (
                                r.fontWeight && "bold" === i(t).fontWeight && (n.bold = !0),
                                Object.keys(n).length > 0 && (e = e.compose(new v.default().retain(e.length(), n))),
                                parseFloat(r.textIndent || 0) > 0 && (e = new v.default().insert("\t").concat(e)),
                                e
                            );
                        },
                    ],
                ...
                q = [O.AlignStyle, w.BackgroundStyle, x.ColorStyle, k.DirectionStyle, E.FontStyle, j.SizeStyle].reduce(function (t, e) {
                ...
                T = (function (t) {
                    function e(t, n) {
                        ...
                        return (
                            ...
                            (r.matchers = []),
                            N.concat(r.options.matchers).forEach(function (t) {
                                r.addMatcher.apply(
                                    r,
                                    (function (t) {
                                        if (Array.isArray(t)) {
                        ...
                        y(e, [
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    return (
                                        l(i, "\n") && null == i.ops[i.ops.length - 1].attributes && (i = i.compose(new v.default().retain(i.length() - 1).delete(1))),
                                        A.log("convert", this.container.innerHTML, i),
                                        (this.container.innerHTML = ""),
                                        i
                                    );
                                },
                                ...
                                value: function (t) {
                                    ...
                                    if (!t.defaultPrevented) {
                                        var n = this.quill.getSelection(),
                                            r = new v.default().retain(n.index).delete(n.length),
                                            o = document.body.scrollTop;
                                        this.container.focus(),
                                            setTimeout(function () {
                                                (r = r.concat(e.convert())),
                                                    e.quill.updateContents(r, g.default.sources.USER),
                                                    e.quill.setSelection(r.length() - n.length, g.default.sources.SILENT),
            ...
            (T.DEFAULTS = { matchers: [] }), (e.default = T), (e.matchAttributor = u), (e.matchBlot = c), (e.matchNewline = f), (e.matchSpacing = h), (e.matchText = p);
        },
        function (t, e, n) {
            "use strict";
        ...
        function (t, e, n) {
            ...
            var r = (function (t) {
                ...
                o = n(47),
                i = new r.default.Attributor.Class("background", "ql-bg", { scope: r.default.Scope.INLINE }),
                l = new o.ColorAttributor("background", "background-color", { scope: r.default.Scope.INLINE });
        ...
        function (t, e, n) {
            ...
            var r = (function (t) {
                ...
                o = { scope: r.default.Scope.INLINE, whitelist: ["serif", "monospace"] },
        ...
        function (t, e, n) {
            ...
            var r = (function (t) {
                ...
                i = new r.default.Attributor.Style("size", "font-size", { scope: r.default.Scope.INLINE, whitelist: ["10px", "18px", "32px"] });
        ...
        function (t, e, n) {
                        ...
                        i(e, [
                            {
                                ...
                                value: function (t, e) {
                                    if (0 !== this.stack[t].length) {
                                        ...
                                        (this.lastRecorded = 0), (this.ignoreChange = !0), this.quill.updateContents(n[t], a.default.sources.USER), (this.ignoreChange = !1);
                                        var r = o(n[t]);
            ...
            (s.DEFAULTS = { delay: 1e3, maxStack: 100, userOnly: !1 }), (e.default = s), (e.getLastChangeIndex = o);
        },
        function (t, e, n) {
            "use strict";
            function r(t) {
            ...
            function o(t) {
                this.quill.deleteText(t, b.default.sources.USER), this.quill.setSelection(t.index, b.default.sources.SILENT), this.quill.selection.scrollIntoView();
            }
            function i(t, e) {
                var n = this;
                t.length > 0 && this.quill.scroll.deleteAt(t.index, t.length);
                var r = Object.keys(e.format).reduce(function (t, n) {
                    return v.default.query(n, v.default.Scope.BLOCK) && !Array.isArray(e.format[n]) && (t[n] = e.format[n]), t;
                }, {});
                this.quill.insertText(t.index, "\n", r, b.default.sources.USER),
                    this.quill.selection.scrollIntoView(),
                    Object.keys(e.format).forEach(function (t) {
                        null == r[t] && (Array.isArray(e.format[t]) || ("link" !== t && n.quill.format(t, e.format[t], b.default.sources.USER)));
                    });
            }
            function l(t) {
                return {
                    ...
                    format: { "code-block": !0 },
                    handler: function (e) {
                        var n = v.default.query("code-block"),
                            r = e.index,
                            o = e.length,
                        ...
                        if (null != a) {
                            var u = this.quill.scroll.offset(a),
                                f = a.newlineIndex(s, !0) + 1,
                                h = a.newlineIndex(u + s + o),
                                p = a.domNode.textContent.slice(f, h).split("\n");
                            (s = 0),
                                p.forEach(function (e, i) {
                                    t
                                        ? (a.insertAt(f + s, n.TAB), (s += n.TAB.length), 0 === i ? (r += n.TAB.length) : (o += n.TAB.length))
                                        : e.startsWith(n.TAB) && (a.deleteAt(f + s, n.TAB.length), (s -= n.TAB.length), 0 === i ? (r -= n.TAB.length) : (o -= n.TAB.length)),
                                        (s += e.length + 1);
                                }),
                                this.quill.update(b.default.sources.USER),
                                this.quill.setSelection(r, o, b.default.sources.SILENT);
                        }
                    },
                };
            }
            function a(t) {
                return {
                    ...
                    handler: function (e, n) {
                        this.quill.format(t, !n.format[t], b.default.sources.USER);
                    },
                };
            }
            function s(t) {
                if ("string" == typeof t || "number" == typeof t) return s({ key: t });
                if (("object" === (void 0 === t ? "undefined" : u(t)) && (t = (0, h.default)(t, !1)), "string" == typeof t.key))
                    if (null != w.keys[t.key.toUpperCase()]) t.key = w.keys[t.key.toUpperCase()];
                    else {
            ...
            var u =
                ...
                g = r(n(30)),
                m = r(n(39)),
                _ = (r(n(32)), (0, g.default)("quill:keyboard")),
                ...
                w = (function (t) {
                    function e(t, n) {
                        ...
                        return (
                            ...
                            r.addBinding({ key: e.keys.ENTER, shiftKey: null }, i),
                            ...
                            r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !0, prefix: /^.?$/ }, function (t) {
                                0 !== t.index && (this.quill.deleteText(t.index - 1, 1, b.default.sources.USER), this.quill.selection.scrollIntoView());
                            }),
                            r.addBinding({ key: e.keys.DELETE }, { collapsed: !0, suffix: /^$/ }, function (t) {
                                t.index >= this.quill.getLength() - 1 || this.quill.deleteText(t.index, 1, b.default.sources.USER);
                            }),
                            r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !1 }, o),
                            r.addBinding({ key: e.keys.DELETE }, { collapsed: !1 }, o),
                            r.listen(),
                            r
                        );
                    }
                        ...
                        f(e, null, [
                            {
                                ...
                                value: function (t, e) {
                                    return (
                                        (!!(e = s(e)).shortKey === t[O] || null === e.shortKey) &&
                                        !["altKey", "ctrlKey", "metaKey", "shiftKey"].some(function (n) {
                                            return n != O && !!e[n] !== t[n] && null !== e[n];
                                        }) &&
                        ...
                        f(e, [
                            {
                                ...
                                value: function (t) {
                                    ...
                                    return null == r || null == r.key
                                        ? _.warn("Attempted to add invalid keyboard binding", r)
                                            ...
                                            if (0 !== o.length) {
                                                ...
                                                if (null != i) {
                                                    var l = t.quill.scroll.line(i.index),
                                                        ...
                                                        s = a[0],
                                                        f = a[1],
                                                        h = t.quill.scroll.leaf(i.index),
                                                        d = c(h, 2),
                                                        y = d[0],
                                                        b = d[1],
                                                        g = 0 === i.length ? [y, b] : t.quill.scroll.leaf(i.index + i.length),
                                                        m = c(g, 2),
                                                        _ = m[0],
                                                        O = m[1],
                                                        w = y instanceof v.default.Text ? y.value().slice(0, b) : "",
                                                        x = _ instanceof v.default.Text ? _.value().slice(O) : "",
                                                        k = { collapsed: 0 === i.length, empty: 0 === i.length && s.length() <= 1, format: t.quill.getFormat(i), offset: f, prefix: w, suffix: x };
                                                    o.some(function (e) {
                                                        ...
                                                        if (Array.isArray(e.format)) {
                                                            ...
                                                            !Object.keys(e.format).every(function (t) {
                                                                return !0 === e.format[t] ? null != k.format[t] : !1 === e.format[t] ? null == k.format[t] : (0, p.default)(e.format[t], k.format[t]);
                                                            })
                                                        )
                                                            return !1;
            ...
            (w.keys = { BACKSPACE: 8, TAB: 9, ENTER: 13, ESCAPE: 27, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40, DELETE: 46 }),
                (w.DEFAULTS = {
                    bindings: {
                        bold: a("bold"),
                        italic: a("italic"),
                        ...
                        indent: {
                            ...
                            handler: function (t, e) {
                                return !(!e.collapsed || 0 === e.offset) || void this.quill.format("indent", "+1", b.default.sources.USER);
                            },
                        },
                        outdent: {
                            key: w.keys.TAB,
                        ...
                        "outdent backspace": {
                            ...
                            handler: function (t, e) {
                                null != e.format.indent
                                    ? this.quill.format("indent", "-1", b.default.sources.USER)
                                    : null != e.format.blockquote
                                    ? this.quill.format("blockquote", !1, b.default.sources.USER)
                                    : null != e.format.list && this.quill.format("list", !1, b.default.sources.USER);
                            },
                        },
                        ...
                        "remove tab": {
                            ...
                            prefix: /\t$/,
                            handler: function (t, e) {
                                this.quill.deleteText(t.index - 1, 1, b.default.sources.USER);
                            },
                        },
                        tab: {
                            key: w.keys.TAB,
                            handler: function (t, e) {
                                e.collapsed || this.quill.scroll.deleteAt(t.index, t.length), this.quill.insertText(t.index, "\t", b.default.sources.USER), this.quill.setSelection(t.index + 1, b.default.sources.SILENT);
                            },
                        },
                        "list empty enter": {
                            key: w.keys.ENTER,
                            ...
                            empty: !0,
                            handler: function (t, e) {
                                this.quill.format("list", !1, b.default.sources.USER), e.format.indent && this.quill.format("indent", !1, b.default.sources.USER);
                            },
                        },
                        "header enter": {
                            key: w.keys.ENTER,
                            ...
                            handler: function (t) {
                                this.quill.scroll.insertAt(t.index, "\n"),
                                    this.quill.formatText(t.index + 1, 1, "header", !1, b.default.sources.USER),
                                    this.quill.setSelection(t.index + 1, b.default.sources.SILENT),
                                    this.quill.selection.scrollIntoView();
                            },
                        },
                        "list autofill": {
                            ...
                            handler: function (t, e) {
                                ...
                                this.quill.scroll.deleteAt(t.index - n, n),
                                    this.quill.formatLine(t.index - n, 1, "list", 1 === n ? "bullet" : "ordered", b.default.sources.USER),
                                    this.quill.setSelection(t.index - n, b.default.sources.SILENT);
                            },
                        },
                    },
                }),
        ...
        function (t, e, n) {
                            ...
                            [
                                {
                                    key: "format",
                                    value: function (t, n) {
                                        t !== y.blotName || n ? s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "format", this).call(this, t, n) : this.replaceWith(f.default.create(this.statics.scope));
                                    },
                                },
                                {
                                    key: "remove",
                                    ...
                                    value: function (t, n) {
                                        return (
                                            ...
                                            t === this.parent.statics.blotName
                                                ...
                                                : (this.parent.unwrap(), s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "replaceWith", this).call(this, t, n))
                                        );
                                    },
                                },
                            ],
                        ...
                        [
                            {
                                key: "create",
                                value: function (t) {
                                    return "ordered" === t ? (t = "OL") : "bullet" === t && (t = "UL"), s(e.__proto__ || Object.getPrototypeOf(e), "create", this).call(this, t);
                                },
                            },
                            {
                                key: "formats",
            ...
            (y.blotName = "list"), (y.scope = f.default.Scope.BLOCK_BLOT), (y.tagName = ["OL", "UL"]), (y.defaultChild = "list-item"), (y.allowedChildren = [d]), (e.ListItem = d), (e.default = y);
        },
        function (t, e, n) {
            "use strict";
            function r(t, e) {
                            ...
                            [
                                {
                                    key: "optimize",
                                    value: function () {
                                        l(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "optimize", this).call(this), this.domNode.tagName !== this.statics.tagName[0] && this.replaceWith(this.statics.blotName);
                                    },
                                },
                            ],
                            [
        ...
        function (t, e, n) {
                        ...
                        l(
                            ...
                            [
                                ...
                                },
                                {
                                    key: "sanitize",
                                    value: function (t) {
                                        return i(t, ["http", "https", "mailto"]) ? t : this.SANITIZED_URL;
                                    },
                                },
                            ]
                        ),
            ...
            (s.blotName = "link"), (s.tagName = "A"), (s.SANITIZED_URL = "about:blank"), (e.default = s), (e.sanitize = i);
        },
        function (t, e, n) {
            "use strict";
            function r(t, e) {
                            ...
                            l(
                                ...
                                [
                                    ...
                                    },
                                    {
                                        key: "sanitize",
                                        value: function (t) {
                                            return (0, u.sanitize)(t, ["http", "https", "data"]) ? t : "//:0";
                                        },
                                    },
                                    {
                                        key: "value",
                                    ...
                                    value: function (t, n) {
                                        "height" === t || "width" === t
                                            ? n
                                                ? this.domNode.setAttribute(t, n)
                                                : this.domNode.removeAttribute(t)
                                            : l(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "format", this).call(this, t, n);
                                    },
                                },
                            ],
                            [
        ...
        function (t, e, n) {
            ...
            var h = new s.default.Attributor.Class("token", "hljs", { scope: s.default.Scope.INLINE }),
                p = (function (t) {
                    function e(t, n) {
                        o(this, e);
                        ...
                        u.default.register(h, !0), u.default.register(f, !0);
                        var l = null;
                        return (
            ...
            var a = function (t, e) {
                ...
                v = (function (t) {
                    function e(t, n) {
                        ...
                        var r,
                            i = o(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                        if (Array.isArray(i.options.container)) {
                            var s = document.createElement("div");
                            l(s, i.options.container), t.container.parentNode.insertBefore(s, t.container), (i.container = s);
                        ...
                        return i.container instanceof HTMLElement
                            ? (i.container.classList.add("ql-toolbar"),
                              ...
                              i.container.addEventListener("mousedown", function (t) {
                                  t.preventDefault();
                              }),
                              [].forEach.call(i.container.querySelectorAll("button, select"), function (t) {
                                  i.attach(t);
                              }),
                              i.quill.on(h.default.events.EDITOR_CHANGE, function (t, e) {
                                  t === h.default.events.SELECTION_CHANGE && i.update(e);
                              }),
                              ...
                              i)
                            : ((r = y.error("Container required for toolbar", i.options)), o(i, r));
                    }
                    return (
                        (function (t, e) {
                            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + typeof e);
                                ...
                                value: function (t) {
                                    ...
                                    if (n) {
                                        if (((n = n.slice("ql-".length)), "BUTTON" === t.tagName && t.setAttribute("type", "button"), null == this.handlers[n])) {
                                            if (null != this.quill.scroll.whitelist && null == this.quill.scroll.whitelist[n]) return void y.warn("ignoring attaching to disabled format", n, t);
                                            if (null == f.default.query(n)) return void y.warn("ignoring attaching to nonexistent format", n, t);
                                        }
                                        ...
                                        t.addEventListener(r, function (r) {
                                            ...
                                            else if (f.default.query(n).prototype instanceof f.default.Embed) {
                                            ...
                                            } else e.quill.format(n, o, h.default.sources.USER);
                                            e.update(s);
                                        }),
                                    ...
                                    this.controls.forEach(function (n) {
                                        ...
                                        if ("SELECT" === i.tagName) {
                                            ...
                                            if (null == t) l = null;
                                                ...
                                                var s = e[o];
                                                "string" == typeof s && (s = s.replace(/\"/g, '\\"')), (l = i.querySelector('option[value="' + s + '"]'));
                                            }
                            ...
                            if (null != n)
                                if (0 == n.length) {
                                    ...
                                    Object.keys(r).forEach(function (t) {
                                        null != f.default.query(t, f.default.Scope.INLINE) && e.quill.format(t, !1);
                                    });
                                } else this.quill.removeFormat(n, h.default.sources.USER);
                        },
                        direction: function (t) {
                            var e = this.quill.getFormat().align;
                            "rtl" === t && null == e ? this.quill.format("align", "right", h.default.sources.USER) : t || "right" !== e || this.quill.format("align", !1, h.default.sources.USER),
                                this.quill.format("direction", t, h.default.sources.USER);
                        },
                        link: function (t) {
                            !0 === t && (t = prompt("Enter link URL:")), this.quill.format("link", t, h.default.sources.USER);
                        },
                        indent: function (t) {
                            var e = this.quill.getSelection(),
                            ...
                            if ("+1" === t || "-1" === t) {
                                var o = "+1" === t ? 1 : -1;
                                "rtl" === n.direction && (o *= -1), this.quill.format("indent", r + o, h.default.sources.USER);
                            }
                        },
                    },
                }),
                        ...
                        o(t, [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    return t.classList.add("ql-picker-label"), (t.innerHTML = i.default), this.container.appendChild(t), t;
                                },
                            },
                            {
                                key: "buildOptions",
                ...
                r = (function () {
                    function t(e, n) {
                        ...
                        (function (t, e) {
                            ...
                            (this.quill = e),
                            (this.boundsContainer = n),
                            (this.root = e.addContainer("ql-tooltip")),
                            (this.root.innerHTML = this.constructor.TEMPLATE);
                        var o = parseInt(window.getComputedStyle(this.root).marginTop);
                        this.quill.root.addEventListener("scroll", function () {
                            (r.root.style.marginTop = -1 * r.quill.root.scrollTop + o + "px"), r.checkBounds();
                        }),
                            this.hide();
                    }
                    return (
        ...
        function (t, e, n) {
            ...
            var v = (function (t) {
                function e(t, n) {
                    ...
                    var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                    return (
                        r.quill.on(c.default.events.EDITOR_CHANGE, function (t, e) {
            ...
            (v.TEMPLATE = ['<span class="ql-tooltip-arrow"></span>', '<div class="ql-tooltip-editor">', '<input type="text" data-formula="e=mc^2" data-link="quilljs.com" data-video="Embed URL">', '<a class="ql-close"></a>', "</div>"].join(
                ""
            )),
                (e.default = y);
        },
        function (t, e, n) {
                                ...
                                value: function (t) {
                                    t.forEach(function (t) {
                                        (t.getAttribute("class") || "").split(/\s+/).forEach(function (e) {
                                            if (e.startsWith("ql-") && ((e = e.slice("ql-".length)), null != g.default[e]))
                                                if ("direction" === e) t.innerHTML = g.default[e][""] + g.default[e].rtl;
                                                else if ("string" == typeof g.default[e]) t.innerHTML = g.default[e];
                                                else {
                                                    var n = t.value || "";
                                                    null != n && g.default[e][n] && (t.innerHTML = g.default[e][n]);
                                                }
                                        });
                                    });
                                },
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    this.pickers = t.map(function (t) {
                                        if (t.classList.contains("ql-align")) return null == t.querySelector("option") && a(t, m), new y.default(t, g.default.align);
                                        if (t.classList.contains("ql-background") || t.classList.contains("ql-color")) {
                                            ...
                                            return null == t.querySelector("option") && a(t, _, "background" === e ? "#ffffff" : "#000000"), new d.default(t, g.default[e]);
                                        }
                                        return null == t.querySelector("option") && (t.classList.contains("ql-font") ? a(t, O) : t.classList.contains("ql-header") ? a(t, w) : t.classList.contains("ql-size") && a(t, x)), new v.default(t);
                                    });
                                    var n = function () {
                                    ...
                                    this.quill.on(f.default.events.SELECTION_CHANGE, n).on(f.default.events.SCROLL_OPTIMIZE, n);
                                },
                            },
                        ]),
                        e
            ...
            k.DEFAULTS = (0, u.default)(!0, {}, p.default.DEFAULTS, {
                modules: {
                    toolbar: {
                        handlers: {
                            formula: function (t) {
                            ...
                            image: function (t) {
                                ...
                                null == n &&
                                    ((n = document.createElement("input")).setAttribute("type", "file"),
                                    ...
                                    n.addEventListener("change", function () {
                                        if (null != n.files && null != n.files[0]) {
                                            ...
                                            (t.onload = function (t) {
                                                ...
                                                e.quill.updateContents(new c.default().retain(r.index).delete(r.length).insert({ image: t.target.result }), f.default.sources.USER), (n.value = "");
                                            }),
                            ...
                            value: function () {
                                ...
                                switch (this.root.getAttribute("data-mode")) {
                                    case "link":
                                        ...
                                        this.linkRange ? (this.quill.formatText(this.linkRange, "link", t, f.default.sources.USER), delete this.linkRange) : (this.restoreFocus(), this.quill.format("link", t, f.default.sources.USER)),
                                    ...
                                    case "formula":
                                        var r = this.quill.getSelection(!0),
                                            o = r.index + r.length;
                                        null != r &&
                                            (this.quill.insertEmbed(o, this.root.getAttribute("data-mode"), t, f.default.sources.USER),
                                            "formula" === this.root.getAttribute("data-mode") && this.quill.insertText(o + 1, " ", f.default.sources.USER),
                                            this.quill.setSelection(o + 2, f.default.sources.USER));
                                }
        ...
        function (t, e, n) {
            ...
            var a = function (t, e) {
                ...
                d = r(n(59)),
                y = (r(n(100)), n(40)),
                v = [[{ header: ["1", "2", "3", !1] }], ["bold", "italic", "underline", "link"], [{ list: "ordered" }, { list: "bullet" }], ["clean"]],
                b = (function (t) {
                    function e(t, n) {
