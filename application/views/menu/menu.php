         ...
         <div class="container-fluid">
            ...
            <div class="col-12">
                  ...
                  <div class="top-right-button-container">
                     ...
                     <a type="button" class="btn btn-primary" href="<?php echo base_url().'menu/add_menu'?>">Add Menu</a>
                  ...
                  <table id="datatableRows" class="data-table responsive nowrap" data-order="[[ 0, &quot;asc&quot; ]]">
                     ...
                     <tbody>
                        ...
                        ?>
                           <tr>
                              <td>
                                  <a href="<?php echo base_url().'menu/update_menu/'.$val['m_id']?>"><i class="simple-icon-pencil"></i> 
                                 </a>
                              </td>
                                ...
                                <td>
                                    <a href="<?php echo base_url().'menu/update_menuimg/'.$val['m_id']?>"><i class="simple-icon-pencil"></i> 
                                    </a>
                                    <a href="<?php echo base_url().'upload/menuimg/'.$val['m_img']?>" target = "_blank"><?php echo $val['m_img'];?>
                                    </a>
                                 </td>
