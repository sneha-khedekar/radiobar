 ...
 <div class="container-fluid">
    <div class="row">
       <div class="col-12">
          ...
          <div class="top-right-button-container">
             ...
             <a type="button" class="btn btn-primary" href="<?php echo base_url().'testimonial/add_testimonial'?>">Add Testimonials </a>
             <div class="btn-group">
    ...
    <div class="row">
       <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
            <?php
               if($this->session->flashdata('Managementmsg')){
               ?>
                 <div class="alert alert-success mb-2" role="alert">
                   ...
                   <?php
                       echo $this->session->flashdata('Managementmsg');
                   ?>
                 </div>
               <?php
                }
                ...
                ?>
                   <tr>
                      <td>
                          ...
                          <a href="<?php echo base_url().'testimonial/update_testimonial/'.$val['t_id']?>"><i class="simple-icon-pencil"></i> 
                         </a>
                      </td>
                   
                     
                        <td><?php echo $val['t_name'];?></td>
                        <td><?php echo $val['t_img'];?></td>
                        <td><?php echo $val['t_designation'];?></td>
