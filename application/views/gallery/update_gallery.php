                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label for="companyinput1" >Name</label>
                                  <input type="text" class="form-control" name="name" value="<?php echo $g['g_name'];?>">
                              </div>
                           </div>
                        </div> 
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <!-- <input type="file" class="form-control" name="image" value="<?php echo $g['g_img'];?>"> -->
                                 <input type="file"  name ='image'>
                                 
                                  <a href="<?php echo base_url().'upload/clientimg/'.$g['g_img'];?>" target = "_blank">
                               <img src="<?php echo base_url().'upload/clientimg/'.$g['g_img'];?>" width = "50px" height = "50">
                                </a>
