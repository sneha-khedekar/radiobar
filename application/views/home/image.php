            ...
            <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                ...
                <table id="datatableRows" class="data-table responsive nowrap" data-order="[[ 0, &quot;asc&quot; ]]">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?php echo $val['hs_title'];?></td>
                            <td style="padding: 10px;"><a
                                    href="<?php echo base_url().'upload/homeslider/'.$val['hs_img'];?>"
                                    target="_blank"><?php echo $val['hs_img']?></a></td>
                            <td><a href="<?php echo base_url().'homeslider/update/'.$val['hs_id']?>"><i
                                        class="simple-icon-pencil"></i>
                                </a></td>
                            <!-- <td><a href="<?php echo base_url().'homeslider/update_mobileimg/'.$val['hs_id']?>"><i class="simple-icon-pencil"><?php echo $val['hs_mobimg']?></i> 
                                 </a></td> -->
