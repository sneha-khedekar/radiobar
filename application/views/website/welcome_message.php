...
<!-- Mirrored from themeperch.net/html/eventiva/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Nov 2023 06:45:25 GMT -->
<head>
		<meta charset="utf-8">
	...
	<body class="home-1">
				...
				<nav class="navbar navbar-expand-xl">
					<div class="d-flex w-100 justify-content-between align-items-center" style="height:120px">
						<a class="navbar-brand" href="index.html" aria-label="nav-brands">
							<img src="assets/images/global/radiobar logo (1).png" class="logo-light" alt="logo">
							<img src="assets/images/global/radiobar logo.png" class="logo-dark" alt="logo">
						</a>
						...
						<div class="d-none d-xl-block" style="font-size:20px">
							<div class="d-flex gap-40 align-items-center">
								<ul class="list-unstyled d-flex gap-40 navbar-nav mb-2 me-2 mb-lg-0">
									<li class="nav-item">
										<a class="nav-link d-flex align-items-end gap-0 flex-column text-uppercase" aria-current="page" href="#" aria-label="nav-links">
									...
									<li class="nav-item">
										<a class="nav-link d-flex align-items-end gap-0 flex-column text-uppercase" href="about-us.html" aria-label="nav-links">
											<!-- <span class="fw-bold">03</span> -->
											<span class="fw-semibold">About</span>
										</a>
									</li>
									<li class="nav-item">
										<a class="nav-link  d-flex align-items-end gap-0 flex-column text-uppercase" href="blog.html" aria-label="nav-links">
											<!-- <span class="fw-bold">03</span> -->
											<span class="fw-semibold">Explore Our Locations</span>
										</a>
									</li>
									<li class="nav-item">
										<a class="nav-link  d-flex align-items-end gap-0 flex-column text-uppercase" href="contact-us.html" aria-label="nav-links">
											<!-- <span class="fw-bold">03</span> -->
		...
		<!-- <div class="offcanvas offcanvas-top" id="navContentmenu" data-bs-backdrop="static" tabindex="-1">
			...
			<a class="navbar-brand" href="index.html" aria-label="nav-brands"><img src="assets/images/global/radiobar logo.png" alt="logo"></a>
					...
					<div class="hero-wrapper box-hero mx-auto position-relative parallax">
						<div class="container">
							<div class="hero-inner-text position-relative card-img-overlay ">
								<img src="assets/images/home-1/musicfest-1.png" class="musicfest-image mb-10" alt="img">
								<h1 class="soundscapes no-stroke fs-120 fw-extra-bold mt-2 mb-0 wow slideInUp">Unveil the Magic of RadioBar</h1>								
							...
							<div class="event-inner">
								<div class="row align-items-center justify-content-between gy-xl-0 gy-4">
									...
									<div class="col-md-3 col-xxl-2 col-xl-3 col-lg-3">
										<div>
											<a href="#schedule" class="btn btn-primary d-inline-flex align-items-center" aria-label="buttons"><span class="contact-plus-icon"><svg width="41" height="34"><use xlink:href="#contact-plus-icon"></use></svg></span> Interested</a>
										</div>
									</div>
								</div>
							</div>					
						...
						<div class="swiper-wrapper"> 
							<div class="swiper-slide">
								<div class="highlights-item position-relative d-flex flex-column gap-20 px-30 py-40 px-xl-40 py-xl-60 active">
									<div class="highlights-icon">
										<img src="assets/images/home-1/guitar.png" alt="img">
									</div>
							...
							<div class="swiper-slide">
								<div class="highlights-item position-relative  d-flex flex-column gap-20 px-30 py-40 px-xl-40 py-xl-60">
									<div class="highlights-icon">
										<img src="assets/images/home-1/speaker.png" alt="img">
									</div>
							...
							<div class="swiper-slide">
								<div class="highlights-item position-relative  d-flex flex-column gap-20 px-30 py-40 px-xl-40 py-xl-60">
									<div class="highlights-icon">
										<img src="assets/images/home-1/fast-food.png" alt="img">
									</div>
					...
					<div class="row gx-80 gy-30">
						<div class="col-lg-4">
							<div class="lineup-right-content mt-30 mt-lg-0 wow fadeInRight">
								<div class="section-title section-title-style-2 mb-4 mb-lg-30 mb-xxl-40">
									<span class="fs-3 straight-line-wrapper fw-semibold position-relative"> <span class="straight-line"></span>Check out</span>
									<h2 class="title display-3 fw-extra-bold d-flex flex-column">
										<span class="mb-n2 text-opacity">Our </span>
										<span class="sub-title fw-extra-bold primary-text-shadow">Locations</span> 
									</h2>
								</div>
								<!-- section-title -->
...
<section class="blog-section blog-vertical pb-50 pb-lg-80">
	<div class="container">
		...
		<div class="blog-content-wrapper position-relative">
			<div class="ellipse-image-1">
				<img src="assets/images/radiobar3.jpg" alt="ellipse-1">
			</div>
							...
							<div class="row gy-4 align-items-center justify-content-between">
								<div class="col-12">
									<div class="blog-image">
										<img src="assets/images/radiobar2.jpg" class="img-fluid" alt="img">
									</div>
								</div>
								<div class="col-12">
									<div class="blog-left-content">
										<!-- <p><span class="calendar me-10"><svg width="16" height="16"><use xlink:href="#calendar"></use></svg></span>09 Aug 2023</p> -->
										<h2 class="blog-link fs-4 fw-bold"><a class="text-decoration-none" href="blog-single-3.html">Unveils Star-Studded Lineup for Epic Comeback Event!</a></h2>													
										<p class="py-20 mb-3 mb-lg-0">Get ready for a musical extravaganza like never before as Harmonia Music ...</p>
										<div>
											<a href="blog-single-3.html" class="download-link d-flex align-items-center gap-30" aria-label="buttons">Check Venue<span class="ticket-arrow arrow-up-right"><svg width="32" height="32"><use xlink:href="#arrow-up-right"></use></svg></span></a>
										</div>
									</div>
									<!-- left-content -->
								</div>									
					...
					<div class="swiper-slide">
						<div class="blog-content blog-content-2 custom-inner-bg">
							<div class="row gy-4 align-items-center justify-content-between">
								<div class="col-12">
									<div class="blog-image">
										<img src="assets/images/radiobar.jpg" class="img-fluid" alt="img">
									</div>
								</div>
								<div class="col-12">
									<div class="blog-left-content">
							...
							<div class="row gy-4 align-items-center justify-content-between">
								...
								<div class="col-12">
									<div class="blog-left-content">
										...
										<p class="py-20 mb-3 mb-lg-0">Get ready for a musical extravaganza like never before as Harmonia Music ...</p>
										<div>
											<a href="blog-single-3.html" class="download-link d-flex align-items-center gap-30" aria-label="buttons">Read more<span class="ticket-arrow arrow-up-right"><svg width="32" height="32"><use xlink:href="#arrow-up-right"></use></svg></span></a>
										</div>
									</div>
									<!-- left-content -->
								</div>									
					...
					<div class="subscription-wrapper py-50 py-lg-70 py-xxl-100">
						<div class="row justify-content-between gy-40 gy-lg-0">
							...
							<div class="col-lg-12 wow fadeInLeft">
								<h3 class="straight-line-wrapper fw-semibold position-relative mb-20"> <span class="straight-line"></span>Find Your Way To Us</h3>
			...
			<div class="container">	
				<div class="row gy-lg-0 gy-10 justify-content-between align-items-center text-center text-lg-start">
					<div class="col-lg-4 order-3 order-lg-1">
						<p class="custom-sans custom-font-style-1 footer-nav">&copy; 2023 <a href="index.html" class="text-decoration-none" target="_blank">RadioBar</a>. All rights Reserved.</p>
					</div>
					<div class="col-lg-4 order-1 order-lg-2">
						<a class="navbar-brand d-flex justify-content-center" href="index.html" aria-label="nav-brands">
							<img src="assets/images/global/radiobar logo (3).png" class="logo-light" alt="logo">
...
<!-- Mirrored from themeperch.net/html/eventiva/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Nov 2023 06:45:33 GMT -->
</html>