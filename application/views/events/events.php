            ...
            <div class="row">
               <div class="col-12">
                  ...
                  <div class="top-right-button-container">
                     ...
                     <a type="button" class="btn btn-primary" href="<?php echo base_url().'events/add_events'?>">Add Events</a>
                     <div class="btn-group">
                  ...
                  <table id="datatableRows" class="data-table responsive nowrap" data-order="[[ 0, &quot;asc&quot; ]]">
                     ...
                     <tbody>
                        ...
                        ?>
                           <tr>
                              <td>
                                  <a href="<?php echo base_url().'events/update_events/'.$val['ae_id']?>"><i class="simple-icon-pencil"></i> 
                                 </a>
                              </td>
                           
                             
                                <td><?php echo $val['ae_title'];?></td>
                                <td><?php echo date('d-M-Y',strtotime($val['ae_event_date']));?></td>
                                <td>
                                    <a href="<?php echo base_url().'events/update_eventsimg/'.$val['ae_id']?>"><i class="simple-icon-pencil"></i> 
                                    </a>
                                    <a href="<?php echo base_url().'upload/eventsimg/'.$val['ae_image']?>" target = "_blank"><?php echo $val['ae_image'];?>
                                    </a>
                                 </td>
