                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                             <label for="companyinput1" >Event Name</label>
                               <input type="text" class="form-control"name ='title' value="<?php echo $val['ae_title'];?>">
                          </div>
                        </div>
                      </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label for="companyinput1" >Events Date</label>
                                   <input type="date" class="form-control"name ='event_date' value="<?php echo $val['ae_event_date'];?>">
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label for="companyinput1" >Events Url</label>
                                   <input type="text" class="form-control"name ='wurl' value="<?php echo $val['ae_url'];?>">
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="shortdesc" value="<?php echo $val['ae_shortdescription'];?>">
                        ...
                        <div class="row">
                         <div class="col-md-12">
                            ...
                            <label for="companyinput1" >Current Time</label>
                                 <input type="time" class="form-control"name ='time' value="<?php echo $val['ae_current-time'];?>">
                            </div>
                         </div>
                        </div> 
